...
public class Saulfinal {
    ...
    private static void generarBoleta(String nombreCliente, String fechaActual, String metodoPago, double precioGasolina, double igv, double totalConIGV, double montoEntregado, double cambio) {
        String nombreArchivo = "boleta_" + nombreCliente + "_" + fechaActual.replaceAll("[/: ]", "_") + ".txt";
    ...
    public static void comprarlistol(Scanner gaa) {
        ...
        double IGV = 0.18;
        String[] productos = new String[]{"Sandwich Clasica",
                "Pan con queso", "Pan de hot dog", "Pan con huevo",
                "Lays", "Chocman", "Oreo", "Casino", "Wafer", "Coca kola",
                "Inka kola", "Yogurt", "Cafe", "Té", "Chicha morada",
                "Chicha de Jora"};

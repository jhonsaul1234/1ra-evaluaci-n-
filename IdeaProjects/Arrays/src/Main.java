...
public class Main {
    ...
    public static void comprarGasolina(Scanner gaa) {
        ...
        double subtotal = precioGasolina * cantidadGasolina;
        ...
        String[][] detallesPago = {
                ...
                {"Ingrese el monto de pago en efectivo: ", "El monto ingresado es insuficiente. Por favor, ingrese un monto válido."},
                // Detalles para Pago con Tarjeta
                {"Ingrese el número de la tarjeta de crédito: ", "Ingrese la fecha de vencimiento (MM/AA): ", "Ingrese el código CVV: ", "Datos de tarjeta inválidos. Pago fallido. Intente nuevamente."}
        };
        ...
        switch (metodoPago) {
            ...
            case 2:
                ...
                gaa.nextLine(); // Limpiar el buffer después de nextInt
